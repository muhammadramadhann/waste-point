                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-12">
                            ...
                            <section id="no_hp" class="mb-3">
                                <label for="no_hp" class="fw-bold form-label">Nomor Hp</label>
                                <input type="text" class="form-control" id="no_hp" name="no_hp" placeholder="Masukkan nomor hp" value="{{ Auth::user()->no_hp }}">
                                @error('no_hp')
                                    <div class="text-danger mt-2">
                                        {{ $message }}
                                    </div>
