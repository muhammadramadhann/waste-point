...
@section('content')
    ...
    <div class="bg-green rounded p-3 text-center my-4">
        <h3 class="fw-bold mb-0">Detail Penukaran Sampah</h3>
    </div>
    ...
    <div class="text-center">
        @if ($waste->status == 'Belum diverifikasi' || $waste->status == 'Dalam penjemputan')
            <a href="https://wa.me/08111761179" class="btn btn-green rounded px-5 py-2 d-md-inline d-block">Hubungin admin</a>
        @elseif(!$waste->rating)
            ...
            <div class="modal fade" id="confirmModal" tabindex="-1" aria-labelledby="confirmModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <form action="{{ route('user.transaksi-sampah.rating', $waste->nanoid) }}" method="POST">
                        @csrf
        ...
        @else
            <a href="{{ route('penukaran-sampah') }}" class="btn btn-green rounded px-5 py-2 d-md-inline d-block">Tukar sampah lagi</a>
        @endif
    </div>
@endsection