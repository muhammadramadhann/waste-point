                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-5 col-12">
                                <div class="border rounded p-4 mb-4">
                                    ...
                                    <p class="mb-2">{{ $waste->users->no_hp }}</p>
                                    <p class="mb-2">{{ $waste->users->address }}</p>
                                </div>
                                <div class="border rounded p-4 mb-4 mb-lg-0">
                                    <h5 class="fw-bold rounded mb-3">Gambar Sampah</h5>
                                ...
                                <form action="" method="POST">
                                    ...
                                    <div class="mb-4">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" id="created_at" name="created_at" value="{{ $waste->created_at }} WIB" readonly>
                                        </div>
                                        <label for="weight" class="form-label fw-bolder">Berat sampah</label>
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="weight" name="weight" min="1" value="{{ $waste->weight }}" readonly>
