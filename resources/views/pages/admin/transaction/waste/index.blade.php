                                ...
                                <tbody>
                                    @foreach ($wastes as $waste)
                                        <tr>
                                            ...
                                            @endif
                                            <td>
                                                <a href="{{ route('admin.transaksi-sampah.detail', $waste->id) }}" class="btn btn-secondary mb-lg-0 mb-2 me-lg-1 me-0">Detail</a>
                                                <form action="transaksi-sampah/delete/{{$waste->id}}" method="POST" class="d-inline">
                                                    @csrf
