            ...
            <div class="col-xl-4 col-md-6 mb-4">
                <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-2">Total Jumlah Paket Sembako</div>
                                <h4 class="mb-0 font-weight-bold text-gray-800">{{ $groceries }} <span class="fs-6">Paket</span></h4>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <ul class="list-group list-group-flush fw-bold">
                            <li class="list-group-item d-flex align-items-center">
                                ...
                                <a href="{{ route('admin.transaksi-sampah') }}" class="btn btn-green ms-auto">Lihat Data</a>
                            </li>
                            <li class="list-group-item d-flex align-items-center">
                                Penukaran Paket Sembako @if ($update_groceries < 1) <span class="text-green ps-1">(0)</span> @else <span class="text-danger ps-1">({{ $update_groceries }})</span> @endif
                                <a href="{{ route('admin.transaksi-sembako') }}" class="btn btn-green ms-auto">Lihat Data</a>
                            </li>
                        </ul>
                    </div>
                </div>
